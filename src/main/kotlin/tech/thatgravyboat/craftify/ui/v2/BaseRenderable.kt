...
abstract class BaseRenderable(var width: Int, var height: Int) {
    ...
    fun renderWithEffects(graphics: GuiGraphics, mouseX: Int, mouseY: Int, partialTicks: Float) {
    ...
    abstract fun render(graphics: GuiGraphics, mouseX: Int, mouseY: Int, partialTicks: Float)
}