...
interface ServiceConfig {
    ...
    companion object {
        ...
        fun load() {
            val json = file.takeIf { it.exists() }?.runCatching { this.readText(StandardCharsets.UTF_8).readJson() }?.getOrNull() ?: JsonObject()
        ...
        fun save() {
            ...
            this.file.writeText(this.json.toString(), StandardCharsets.UTF_8, StandardOpenOption.CREATE)
        }
