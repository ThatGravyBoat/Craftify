...
object Config : Vigilant(File("./config/craftify.toml")) {
    ...
    init {
        category("General") {
            ...
            switch(::announcementEnabled, "Announcement", "If you want your new song to be announced into chat.")
        ...
        category("Rendering") {
            slider(::xOffset, "Position X Offset", hidden = true)
            slider(::yOffset, "Position Y Offset", hidden = true)
